...
! !USES:
  ...
  use RtmVar          , only : re, spval, rtmlon, rtmlat, iulog, ice_runoff, &
                               ...
                               isgrid2d, data_bgc_fluxes_to_ocean_flag, use_lnd_rof_two_way, use_ocn_rof_two_way, use_linear_inund
...
!-----------------------------------------------------------------------
    ...
    namelist /mosart_inparm / ice_runoff, do_rtm, do_rtmflood, &
         ...
         inundflag, use_linear_inund, smat_option, delt_mosart, barrier_timers, do_budget, &
